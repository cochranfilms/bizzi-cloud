/**
 * POST /api/files/reconcile-macos-package — recompute macos_package_* + container membership from relative_path.
 * Use after client-side path/drive updates or to repair drift.
 */
...
export async function POST(request: Request) {
  ...
  await reconcileMacosPackageMembershipForBackupFile(db, id);
