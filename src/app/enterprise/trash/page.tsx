...
export default function EnterpriseTrashPage() {
  ...
  const dragRectEl =
    showDragRect && dragState ? (
      <div
        className="pointer-events-none fixed z-[9999] border-2 border-[var(--enterprise-primary)] bg-[var(--enterprise-primary)]/20 shadow-lg shadow-[var(--enterprise-primary)]/30"
        style={{
