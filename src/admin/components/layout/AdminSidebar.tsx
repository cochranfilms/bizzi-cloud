...
export default function AdminSidebar({ systemStatus = "healthy" }: AdminSidebarProps) {
  ...
  return (
    <aside
      className={`flex flex-col border-r border-neutral-200 bg-white transition-all duration-200 dark:border-neutral-800 dark:bg-neutral-950 ${
        collapsed ? "w-16" : "w-56"
      }`}
    >
