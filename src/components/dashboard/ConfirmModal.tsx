        ...
        <div className="p-6">
          ...
          <div className="flex flex-wrap justify-end gap-3 pt-2">
            <button
              ...
              onClick={onClose}
              disabled={loading}
              className="min-h-[44px] min-w-[44px] rounded-lg px-4 py-2 text-sm font-medium text-neutral-700 transition-colors hover:bg-neutral-100 dark:text-neutral-300 dark:hover:bg-neutral-800 disabled:opacity-50"
            >
              {cancelLabel}
            </button>
            <button
              ...
              disabled={loading}
              className={`min-h-[44px] min-w-[44px] rounded-lg px-4 py-2 text-sm font-medium text-white transition-colors disabled:opacity-50 ${
                destructive
