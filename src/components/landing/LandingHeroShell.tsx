 ...
 * Gradient comes from `.landing-hero-shell-surface` in `globals.css` (marketing is always light).
 */
export default function LandingHeroShell({ children }: { children: ReactNode }) {
  return (
    ...
    >
      <div
        className="landing-hero-shell-surface relative rounded-t-[3.25rem] rounded-b-[3.25rem] shadow-[inset_0_1px_0_rgba(255,255,255,0.55),inset_0_-1px_0_rgba(255,255,255,0.35)] sm:rounded-t-[3.75rem] sm:rounded-b-[3.75rem] md:rounded-t-[4.25rem] md:rounded-b-[4.25rem] lg:rounded-t-[5rem] lg:rounded-b-[5rem] xl:rounded-t-[5.5rem] xl:rounded-b-[5.5rem]"
      >
        {children}
      </div>
    </div>
